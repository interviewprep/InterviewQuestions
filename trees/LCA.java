...
public class LCA {
	public BinaryTreeNode<Integer> lowestCommonAncestor(BinaryTreeNode<Integer> root, 
		...
		BinaryTreeNode<Integer> right = lowestCommonAncestor(root.right, p, q);
                ...
                // if one of the nodes is in the left subtree and one in the right subtree, the
                // current node is the lowest common ancestor.  
		if(left != null && right != null)   return root;
                // if only of them is not null, the other one is the lowest common ancestor that 
